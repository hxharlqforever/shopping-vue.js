                                ...
                                <div class="address-form">
                                    ...
                                    <div class="module-form-row" >
                                        <div class="form-item-v3" :class="{'form-invalid-item':phoneError}">                                         
                                            <input type="text" class="js-verify" placeholder="手机号" v-model="receive.phone"  @blur="inspectPhone" @focus="spectPhone">
                                    ...
                                    <div class="module-form-row clear">
                                        <div class="form-item-v3 select-item province-wrapper">
                                            <select name="province_code" class="province select-province js-form-province js-verify" v-model="receive.provinceId">
                                               ...
                                               <option :value="city.area_id" v-for="city,index in addlist">{{city.area_name}}</option>                                             
                                            </select>
                                        </div>
                                    </div>
                                    <div class="module-form-row clear">
                                    ...
                                    <div class="dialog-blue-btn big-main-btn " :class="{'disabled-btn':!isright}" @click='submitReceiveHandle'>
                                        <a>保存</a>
                                    </div>
                                </div>
                            </div>
	...
	watch:{	
      ...
      ["receive.cityId"] () {
        if (this.receive.cityId!=0) {
          ...
          this.countrylist = city.county_list
        } else {
          this.countrylist = []
          this.receive.city = ""
      ...
      ["receive.countyId"] () {
        if (this.receive.countyId!=0) {
          let county = this.countrylist.filter((county) => {
